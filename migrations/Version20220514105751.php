 ...
 */
final class Version20220514105751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE slides ADD created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, ADD update_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE slides DROP created_at, DROP update_at, CHANGE titre titre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE sous_titre sous_titre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE image_slides image_slides VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
