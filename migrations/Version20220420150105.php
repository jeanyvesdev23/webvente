 ...
 */
final class Version20220420150105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE status_commande DROP status_paiement, DROP type_paiement');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE status_commande ADD status_paiement TINYINT(1) NOT NULL, ADD type_paiement VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE status_livraison status_livraison VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type_livraison type_livraison VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
