 ...
 */
final class Version20220427103342 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog DROP user_id, CHANGE image_bog image_bog VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE titre_blog titre_blog VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description_blog description_blog LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
