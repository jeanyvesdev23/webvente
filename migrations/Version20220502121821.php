 ...
 */
final class Version20220502121821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE search_product (id INT AUTO_INCREMENT NOT NULL, categorie VARCHAR(255) DEFAULT NULL, min_prix DOUBLE PRECISION DEFAULT NULL, max_prix DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
