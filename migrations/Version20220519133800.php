 ...
 */
final class Version20220519133800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wish_list ADD blog_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE wish_list ADD CONSTRAINT FK_5B8739BDDAE07E97 FOREIGN KEY (blog_id) REFERENCES blog (id)');
        $this->addSql('CREATE INDEX IDX_5B8739BDDAE07E97 ON wish_list (blog_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wish_list DROP FOREIGN KEY FK_5B8739BDDAE07E97');
        $this->addSql('DROP INDEX IDX_5B8739BDDAE07E97 ON wish_list');
        $this->addSql('ALTER TABLE wish_list DROP blog_id');
    }
}
