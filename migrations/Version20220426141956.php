 ...
 */
final class Version20220426141956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE status_commande CHANGE status_livraison status_livraison VARCHAR(255) DEFAULT \'passée\' NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE image_user image_user VARCHAR(255) DEFAULT \'children.jpg\'');
    }
