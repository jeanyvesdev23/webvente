 ...
 */
final class Version20220511074449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD stock INT NOT NULL, DROP wishlist');
    }
